...
public class SistemaDeDetonacionTest {
    ...
    // --- NUEVO: TEST DE DISTANCIA CORTA (Entre 20 y 80 metros) ---
    @Test
    public void testExplosionCortaQuitaMuchaEnergia() {
        Jugador jugador = new Jugador(3);
        Avion avion = new Avion(100.0, 1500.0, 100.0);
        // Misil a 50 metros del avión (1550 - 1500)
        Misil misil = new Misil(100.0, 1550.0);
        SistemaDeDetonacion sistema = new SistemaDeDetonacion();
        sistema.aplicarEfecto(misil, avion, jugador);
        assertEquals(60.0, avion.getEnergia(), "Explosión corta (20-80m): debería quitar 40% de energía (100 - 40 = 60).");
        assertEquals(0, jugador.getPuntaje(), "No debería sumar puntos en este rango.");
